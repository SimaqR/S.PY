...
while True:
    ...
    if state == "start":
        screen.fill((0, 0, 0))
        screen.blit(font.render("Shooter Game", True, (255,255,255)), (300, 200))
        screen.blit(font.render("Press SPACE to Start", True, (200,200,200)), (250, 300))
        pygame.display.flip()
        clock.tick(60)
    ...
    if state == "loading":
        ...
        screen.blit(font.render("Loading....", True, (255,255,255)), (330, 280))
        if pygame.time.get_ticks() - loading_time > 2000:
            state = "Playing"
        pygame.display.flip()
        clock.tick(60)
        continue
    ...
    if state == "gameover":
        ...
        screen.fill((20, 0, 0))
        screen.blit(font.render("GAME OVER", True, (255,0,0)), (300, 200))
        screen.blit(font.render(f"Score: {score}", True, (255,255,255)), (320, 260))
        screen.blit(font.render("Press SPACE to Restart", True, (200,200,200)), (230, 320))
        pygame.display.flip()
        clock.tick(60)
        continue
